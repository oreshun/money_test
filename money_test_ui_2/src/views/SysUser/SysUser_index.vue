        ...
        <div class="search_all">
          <div class="search-wrapper">
            ...
            <div class="money-range">
              <el-input-number v-model="MinMoney" :min="0" :step="1000" label="最低额度" style="width: 120px;">
                <template #prefix>
                  <span>￥</span>
                </template>
              </el-input-number>
              <span style="padding: 10px;">-</span>
              <el-input-number v-model="MaxMoney" :min="0" :step="1000" label="最高额度" style="width: 120px;">
                <template #prefix>
                  <span>￥</span>
                </template>
              </el-input-number>
